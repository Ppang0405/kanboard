...
class RouteProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $container)
    {
        ...
        if (ENABLE_URL_REWRITE) {
            ...
            $container['route']->addRoute('project/:project_id/file/:file_id/office', 'FileViewerController', 'office');
            ...
            $container['route']->addRoute('task/:task_id/file/:file_id/office', 'FileViewerController', 'office');
